#CODE TO FETCH IMAGES FROM COLIN ROFLS, @INTERESTING_JPG TWITTER BOT
#Repository here: https://github.com/cmyr/INTERESTING_JPG
...
def response_for_image(image_url, client_name):
    ...
    headers = {
        ...
        'User-agent': "clientname %s v. 1.0" % client_name
    }
    try:
